...
#' is smoothed using a loess smoother, and the time of peak is returned. It is recommended
#' that plotresult is set to TRUE in the first instance to visually confirm the analysis.
#'
#'
